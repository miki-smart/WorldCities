...
namespace WorldCities.Server.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(ApplicationDbContext context, IWebHostEnvironment env, IConfiguration config)
        {
            _config = config;
            _env = env;
            _context = context;
        ...
        {
            // prevents non-development environments from running this meth
...
for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                nRow, 1, nRow, worksheet.Dimension.End.Column]; var countryName = row[nRow, 5].GetValue<string>();
